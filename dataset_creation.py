...
FORMATTED_INPUT_FILE = 'dataset/final_test_dataset_5.csv'
SENTIMENT_FILE = 'sentiment_analysis/final_test_dataset_5_sentiment.json'
OUTPUT_FILE = "sentiment_analysis/final_test_dataset_5.csv"
CLUSTER_FILE = ""
CLUSTER = False
ELIMINATE_OUTLIERS = True

HEADER = "tweet_id" + SEP + "fake" + SEP + "joy" + SEP + "sadness" + SEP +\
         "anger" + SEP + "fear" + SEP + "disgust" + SEP + "sentiment"
